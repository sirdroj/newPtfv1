            ...
            <div className='lg:w-2/4 lg:pl-12 lg:mt-0 mt-10 pb-2'>
                ...
                <div className='mt-8 font-manrope'>
                    ...
                    <div className='flex  items-center mt-10 text-base'>
                        <a className='text-highGreen flex items-center mr-6 border-b-2 border-highGreen'>LIVE DEMO
                            <svg className='ml-1' width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.9897 14.2175L12.3036 3.90363V11.3891L14.3033 11.3891L14.3033 0.48972L3.40391 0.48972L3.40391 2.48942L10.8893 2.48942L0.575487 12.8033L1.9897 14.2175Z" fill="#D3E97A" />
                            </svg>
                        </a>
                        <a className='text-highGreen flex items-center border-b-2 border-highGreen'>See on Github
                            <svg className='ml-1 ' width="26" height="26" fill="none" xmlns="http://www.w3.org/2000/svg">
