    ...
    return (
        <div className='flex justify-between w-full item-center'>
            ...
            <div className=' my-36 w-2/5'>
                <div className='text-white font-normal text-8xl'>
                    <h1>HI, I AM </h1>
                    <hi>AMAN SHARMA</hi>
                </div>
                <p className='font-medium text-lg'>A Bangalore based Software engineers passionate about building accessible and user friendly Software.</p>
                <div className='flex'>
