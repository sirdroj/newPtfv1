        ...
        <div className='lg:flex justify-between w-full item-center h-screen mb-16'>
            ...
            <div className=' lg:my-36 my-10  lg:w-2/5 w-full'>
                ...
                <div className='flex mt-10'>
                    <a  className="mx-2 text-gray-600 text-base font-bold font-manrope bg-primary rounded-full p-2 px-6 text-center items-center align-middle flex"><h1>CONTACT ME</h1> <div className='ml-3 bg-black rounded-full w-2 h-2 items-center flex'></div></a>
